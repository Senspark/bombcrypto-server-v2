...
--
-- Name: logs_user_buy_auto_mine; Type: TABLE; Schema: logs; Owner: -
--
...
--
-- Native (BNB / POL) deposit objects (from migration 20260724_120000_add_native_deposit.sql)
-- Hand-maintained to match the migration. user_native_deposited is the wei-exact mirror of the
-- on-chain counters and caps the withdraw signature; the user_block_reward BNB_DEPOSITED /
-- POL_DEPOSITED doubles are the spendable balance. config_native_rate seed rows stay in the

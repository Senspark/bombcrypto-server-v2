...
class VicLoginManager(
    ...
    override fun loginVic(
        ...
        val info = _authApi.verifyVicUser(walletAddress, loginData)
        ...
        user.dataType = EnumConstants.DataType.VIC
        user.deviceType = deviceType
        user.aesKey = AesEncryption.importKeyFromBase64(info.aesKey)
        user.username = UserNameSuffix.tryAddNameSuffix(user.username, EnumConstants.DataType.VIC)

package com.senspark.game.schema.utils
...
fun Table.varcharArray(name: String, colLength: Int, size: Int? = null): Column<Array<String>> =
    array(name, currentDialect.dataTypeProvider.varcharType(colLength), size)

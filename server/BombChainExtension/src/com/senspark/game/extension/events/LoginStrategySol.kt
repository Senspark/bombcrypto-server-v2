...
class LoginStrategySol(services: GlobalServices) : ILoginStrategy {
    private val _serverType = ServerType.SOL
    ...
    override fun login(userName: String, loginToken: String, extra: LoginExtraData): IUserInfo {
        val u = _loginManager.loginSol(userName, loginToken, extra.deviceType)

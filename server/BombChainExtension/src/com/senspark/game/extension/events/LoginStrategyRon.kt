...
class LoginStrategyRon(services: GlobalServices) : ILoginStrategy {
    private val _serverType = ServerType.RON
    ...
    override fun login(userName: String, loginToken: String, extra: LoginExtraData): IUserInfo {
        val u = _loginManager.loginRon(userName, loginToken, extra.deviceType)

...
import com.senspark.game.api.login.RonLoginManager
...
class ServicesInitializerRon(
    ...
    override fun createService(): ServerServices {
        ...
        val logger = RemoteLogger(env.logRemoteData, "ron")

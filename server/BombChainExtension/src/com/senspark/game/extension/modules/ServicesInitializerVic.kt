...
import com.senspark.game.api.login.VicLoginManager
...
class ServicesInitializerVic(
    ...
    override fun createService(): ServerServices {
        ...
        val logger = RemoteLogger(env.logRemoteData, "vic")

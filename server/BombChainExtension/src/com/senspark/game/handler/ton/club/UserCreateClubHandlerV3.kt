...
class UserCreateClubHandlerV3 : BaseEncryptRequestHandler() {
    override val serverCommand = SFSCommand.CREATE_CLUB_V3
    ...
    override fun handleGameClientRequest(controller: IUserController, requestId: Int, data: ISFSObject) {
        ...
        try {
            ...
            clubManager.createClubV3(controller.userId, clubName)

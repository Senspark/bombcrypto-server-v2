...
class GetBidPriceHandler : BaseEncryptRequestHandler() {
    override val serverCommand = SFSCommand.GET_BID_PRICE_V2
    ...
    override fun handleGameClientRequest(controller: IUserController, requestId: Int, data: ISFSObject) {
        ...
        try {
            ...
            val bidPackage = controller.svServices.get<IClubManager>().getBidPackage(clubId)
            val response = SFSObject().apply {
                putSFSArray("data", bidPackage.toSFSArray {
                    SFSObject().apply {

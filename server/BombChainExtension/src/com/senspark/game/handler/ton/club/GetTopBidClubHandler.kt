...
class GetTopBidClubHandler : BaseEncryptRequestHandler() {
    override val serverCommand = SFSCommand.GET_TOP_BID_CLUB_V2
    ...
    override fun handleGameClientRequest(controller: IUserController, requestId: Int, data: ISFSObject) {
        ...
        try {
            val response = controller.svServices.get<IClubManager>().getTopBidClub()

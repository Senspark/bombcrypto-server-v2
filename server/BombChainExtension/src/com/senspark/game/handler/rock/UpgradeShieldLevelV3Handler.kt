...
class UpgradeShieldLevelV3Handler : BaseEncryptRequestHandler() {
    override val serverCommand = SFSCommand.UPGRADE_SHIELD_LEVEL_V3
    ...
    override fun handleGameClientRequest(controller: IUserController, requestId: Int, data: ISFSObject) {
        try {
            ...
            val (nonce, signature) = userRockManager.upgradeShieldLevelV3(controller, hero, debugFakePush)

...
${JAVA_CMD} -cp ${CPATH} -Dfile.encoding=UTF-8 -Xdebug -Xnoagent -Xrunjdwp:transport=dt_socket,address=0.0.0.0:9898,server=y,suspend=n com.smartfoxserver.v2.Main $1 $2
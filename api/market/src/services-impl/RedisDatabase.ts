import {ILogger, IRedisDatabase} from "@project/Services";
import {IRedisField, IRedisHash, IRedisSet, MultipleFields, SingleField} from "@project/services/IRedisDatabase";
import getRedisClient from "@project/services-impl/Redis";
...
export default class RedisDatabase implements IRedisDatabase {
    ...
    constructor(
        ...
        this.hashes = new Hash(this._redis, this.#logger);
    }

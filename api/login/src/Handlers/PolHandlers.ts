...
export class PolHandlers {
    constructor(
        private readonly _dep: IDependencies,
    ) {
        this._logger = _dep.logger.clone('[POL]');
        ...
        this._loginService = new WebLoginService(
            _dep,
            RedisKeys.AP_POL_LOGIN_PRIVATE_KEY,
            RedisKeys.AP_POL_LOGIN_JWT_REFRESH,
            wallet
        );
